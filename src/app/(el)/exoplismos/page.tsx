...
import { FleetPage } from "@/components/pages";
...
export const metadata: Metadata = (() => {
  const t = dict("el");
  const title = t.fleet.metaTitle;
  const description = t.fleet.metaDescription;
  const alt = alternates({ page: "fleet" });
  return {
    title,
    description,
    alternates: {
      canonical: href("el", { page: "fleet" }),
      languages: {
        el: abs(alt.el),
        en: abs(alt.en),
        "sr-Latn": abs(alt.sr),
