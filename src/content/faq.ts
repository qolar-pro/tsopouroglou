...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: "Βάση μας η Μεταμόρφωση και ο οικισμός Δασκάλων. Δουλεύουμε σε Νικήτη, Βατοπέδι και Ψακούδια, και πιο πέρα σε Ορμύλια, Πολύγυρο, Μεταγγίτσι, Γερακινή και Άγιο Νικόλαο — δηλαδή στη Σιθωνία και στον δήμο Πολυγύρου. Αν το οικόπεδό σας είναι κάπου ανάμεσα και δεν ξέρετε σε ποιο χωριό μετράει, πείτε μας πού είναι· εμείς ξέρουμε τον δρόμο.",
  },
  {
