...
export const etaireia = {
  ...
  lede: "Δεν είμαστε εταιρεία με γραφείο. Είμαστε δύο αδέρφια με μηχανήματα, στο ίδιο χωριό, από το 1987.",
  blocks: [
    {
    ...
    {
      heading: "Με χαρτιά",
      body: "Πτυχίο χειριστή μηχανημάτων έργου από το 1990. Δεν είναι κάτι που διαφημίζεται συνήθως στον κλάδο, αλλά είναι η διαφορά ανάμεσα σε κάποιον που έχει μάθει τη δουλειά και σε κάποιον που αγόρασε ένα μηχάνημα.",
    },
    {
...
export const epikoinonia = {
  ...
  lede: "Το τηλέφωνο είναι ο γρηγορότερος τρόπος και είναι ανοιχτό όλο το 24ωρο. Αν προτιμάτε να γράψετε, συμπληρώστε τη φόρμα και σας παίρνουμε εμείς.",
  formHeading: "Ζητήστε προσφορά",
  formLede:
    "Τέσσερα πεδία. Πείτε μας τι δουλειά είναι και σε ποια περιοχή, και θα σας πούμε τι χρειάζεται και πόσο κάνει.",
} as const;
